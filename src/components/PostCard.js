...
export default function PostCard(post) {
  ...
  async function sendReportEmail() {
    const url = `mailto:${"hernanpormachideveloper@gmail.com"}?subject=Report&body=${"This is an automatic email to the Code With Beto Reporting team. Please write any concerns above this paragraph and do not delete anything below. " +
      "User ID: " +
      user.id +
      "\n" +
      "Post ID: " +
